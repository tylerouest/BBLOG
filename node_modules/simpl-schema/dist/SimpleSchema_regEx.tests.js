...
describe('SimpleSchema', function () {
  ...
  it('Built-In RegEx and Messages', function () {
    var schema = new _SimpleSchema.SimpleSchema({
      ...
      emailWithTLD: {
        type: String,
        regEx: _SimpleSchema.SimpleSchema.RegEx.EmailWithTLD,
        optional: true
      },
      domain: {
        type: String,
        regEx: _SimpleSchema.SimpleSchema.RegEx.Domain,
        optional: true
      },
      weakDomain: {
        type: String,
        regEx: _SimpleSchema.SimpleSchema.RegEx.WeakDomain,
        optional: true
      },
      ip: {
        type: String,
        regEx: _SimpleSchema.SimpleSchema.RegEx.IP,
        optional: true
      },
      ip4: {
        type: String,
        regEx: _SimpleSchema.SimpleSchema.RegEx.IPv4,
        optional: true
      },
      ip6: {
        type: String,
        regEx: _SimpleSchema.SimpleSchema.RegEx.IPv6,
        optional: true
      },
      url: {
        type: String,
      ...
      id: {
        type: String,
        regEx: _SimpleSchema.SimpleSchema.RegEx.Id,
        optional: true
      }
    });
